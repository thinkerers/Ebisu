<!DOCTYPE html>
<html data-transition="<?= $transition ?? '' ?>">
...
<body>
    <?php if (isset($_SESSION['user'])) { ?>
        <header>
            <nav>
                <a  href="index.php?action=editAccount" class="material-symbols-outlined">account_circle</a>
                <a href="index.php?action=handleTasks" class="material-symbols-outlined">add_task</a>
